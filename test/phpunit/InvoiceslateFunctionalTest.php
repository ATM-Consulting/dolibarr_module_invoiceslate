...
/**
 * \file    test/phpunit/InvoiceslateFunctionalTest.php
...
/**
 * Class InvoiceslateFunctionalTest
 *
 ...
 *
 * @package Testinvoiceslate
 */
class InvoiceslateFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modInvoiceslate')->click();
		} else {
			// Disable the module
			$this->byHref('modInvoiceslate')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/invoiceslate/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('invoiceslate/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/invoiceslate/admin/about.php');
		$this->authenticate();
		return $this->assertContains('invoiceslate/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('invoiceslatewidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modInvoiceslate_InvoiceslateTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modInvoiceslate_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
