...
/**
 *	\file       invoiceslate/invoiceslateindex.php
 *	\ingroup    invoiceslate
 *	\brief      Home page of invoiceslate top menu
 */
...
$langs->loadLangs(array("invoiceslate@invoiceslate"));

$action = GETPOST('action', 'alpha');


// Security check
//if (! $user->rights->invoiceslate->myobject->read) accessforbidden();
...
llxHeader("", $langs->trans("InvoiceslateArea"));

print load_fiche_titre($langs->trans("InvoiceslateArea"), '', 'invoiceslate.png@invoiceslate');
...
// Draft MyObject
if (! empty($conf->invoiceslate->enabled) && $user->rights->invoiceslate->read)
{
	$langs->load("orders");
