...
// Translations
$langs->loadLangs(array('invoiceslate@invoiceslate', 'admin', 'other'));
 ...
 * View
 */
$page_name = "InvoiceslateSetupPage";
...
dol_fiche_head(
	$head,
	'settings',
	$langs->trans("ModuleInvoiceslateName"),
	-1,
